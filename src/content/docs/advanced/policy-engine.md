...
[RFC-008](https://github.com/marcjazz/authkestra/blob/main/docs/rfc-008-policy-engine.md).
:::
...
evaluation is not the expensive part of your request — see RFC-008 §7 for the method and the
caveats.
